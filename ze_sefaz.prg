...
FUNCTION CurlSoapPost()
   ...
   Curl_Easy_SetOpt( oCurl, HB_CURLOPT_SSLCERT, cCertificadoChavePublica )
   Curl_Easy_SetOpt( oCurl, HB_CURLOPT_KEYPASSWD, cCertificadoSenha )
   Curl_Easy_SetOpt( oCurl, HB_CURLOPT_SSLKEY, cCertificadoChaveParticular )
   Curl_Easy_SetOpt( oCurl, HB_CURLOPT_POST, 1 )
   Curl_Easy_SetOpt( oCurl, HB_CURLOPT_POSTFIELDS, ::cXmlDados )
   ...
   nConnectionStatus := Curl_Easy_GetInfo( oCurl, HB_CURLINFO_RESPONSE_CODE ) //informacoes da conexao
   IF nConnectionStatus = 200 // OK
